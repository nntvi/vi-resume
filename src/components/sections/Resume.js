          ...
          <div className="col col-d-12 col-t-12 col-m-12 border-line-v">
            ...
            <div className="resume-items">
              <div className="resume-item border-line-h active">
                <div className="date">01/2021 - Present</div>
                ...
                <p>
                  ...
                  task and workflow management, stock management, human resource
              ...
              <div className="resume-item border-line-h">
                ...
                <p>
                  ...
                  provide various features of product management, human resource
                  management, ranking system, and many more.
                </p>
                <div>
                  <div className="name">Technologies: </div>
                  ReactJS - Javascript
              ...
              <div className="resume-item border-line-h">
                ...
                <div className="company">ITBee Solutions</div>
                <p>
                  I worked on a real-estate product that provides a marketplace
                  and workplace for the real-estate industry, including blogs,
                  real-time messaging, recommendation system, advanced analytics
                  and reports
                </p>
                <br />
                <div>
